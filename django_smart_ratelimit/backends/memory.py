...
class MemoryBackend(BaseBackend):
    ...
    def __init__(self):
        ...
        self._cleanup_interval = getattr(settings, 'RATELIMIT_MEMORY_CLEANUP_INTERVAL', 300)  # 5 minutes
        
        # Cleanup tracking
        self._last_cleanup = time.time()
        self._use_sliding_window = getattr(settings, 'RATELIMIT_USE_SLIDING_WINDOW', True)
    ...
    def get_count(self, key: str) -> int:
        ...
        with self._lock:
            ...
            if self._use_sliding_window:
                ...
                # This is a limitation of the get_count method - we don't know the period
                period = 60
                cutoff_time = now - period
    ...
    def _cleanup_if_needed(self) -> None:
        ...
        if (now - self._last_cleanup < self._cleanup_interval and 
            len(self._data) <= self._max_keys):
            return
