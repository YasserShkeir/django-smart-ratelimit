...
class RedisBackendTests(TestCase):
    ...
    def setUp(self):
        ...
        self.redis_patcher = patch('django_smart_ratelimit.backends.redis_backend.redis')
    ...
    @override_settings(RATELIMIT_REDIS={
        'host': 'custom-host',
        'port': 6380,
        'db': 1,
        'password': 'secret'
    ...
    def test_redis_backend_incr_sliding_window(self):
        ...
        self.assertEqual(args[2], 'ratelimit:test_key')  # key with prefix
    ...
    def test_redis_backend_reset(self):
        ...
        self.mock_redis_client.delete.assert_called_once_with('ratelimit:test_key')
    ...
    def test_redis_backend_get_count_sliding_window(self):
        ...
        self.mock_redis_client.zcard.assert_called_once_with('ratelimit:test_key')
    ...
    def test_redis_backend_get_count_fixed_window(self):
        ...
        self.mock_redis_client.get.assert_called_once_with('ratelimit:test_key')
    ...
    def test_redis_backend_get_reset_time(self):
        ...
        self.mock_redis_client.ttl.assert_called_once_with('ratelimit:test_key')
